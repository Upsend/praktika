...
<body>
	<form method="POST">
		<input type="text" name="fio" class="form-control" id="username" aria-describedby="emailHelp" placeholder="Введите имя водителя">
...
require_once('vendor/autoload.php'); 
 ...
 ?>
	<div class="putevka" id="ramka">
		...
		<form action="putevka.php" method="POST">
