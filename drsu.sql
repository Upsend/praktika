...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 19 2019 г., 19:13
...
(5, '6', 'К114ТО56', 'МАЗ-855'),
(6, '7', 'Р450ММ', 'УРАЛ-255'),
(7, '8', 'О109ТС56', 'ПАЗ-200'),
(11, '9', 'М451ОТ56', 'УАЗ Патриот');
...
(7, '6', 'ЯкушевВладимирБорисович', '85544552', 'В,С,Е', 6),
(9, '7', 'ПетровПетрПетрович', '2022535', 'В, С, Е', 7),
(10, '8', 'СидорчукОлегБорисович', '6789557', 'В,С,Е', 11),
(11, '9', 'АлексеевИгорьПетрович', '8961105', 'В,С,Е', 2),
(12, '10', 'ПриходковЮрийАлексеевич', '100555225', 'В,С,Е', 1);
...
(9, 'admin', 'Дорожное строительство', 'admin', 'admin', 'admin');
...
--
ALTER TABLE `objects`
  MODIFY `id_оъекта` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
